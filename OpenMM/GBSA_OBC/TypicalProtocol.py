...
system = forceField.createSystem(modeller.topology, nonbondedCutoff=20*angstrom)
...
# GBSAOBCForce in present in a system. This is wrong and causes problems: see
# https://github.com/SimTk/openmm/issues/26 . This turns the reaction field off.
