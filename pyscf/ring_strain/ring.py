...
def opt_molecule(opt_mol):
   ...
   opt_mol = berny_solver.optimize(method, verbose=5)
...
a = opt_molecule(one_six_heptadiene)
b = opt_molecule(cyclopentene)
...
#print ( str(c) + " H")
#print ( "")
print( str((( b + c ) - a )*627.509) + " kcal of ring strain")
